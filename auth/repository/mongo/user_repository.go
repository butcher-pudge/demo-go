...
func (repository UserRepository) CreateUser(ctx context.Context, user *models.User) error {
...
func (repository UserRepository) GetUser(ctx context.Context, username, password string) (*models.User, error) {
	user := new(User)
